...
last_modified_at: 2026-04-29 12:00:00 -0500
...
faq:
  - q: "¿El helado de whisky tiene alcohol?"
    a: "El variegato Whisky MEC3 contiene una pequeña cantidad de alcohol real derivado del whisky, inferior al 1% vol. en el helado terminado a dosificación estándar (80-100g/L). El sabor a whisky es claramente perceptible pero el contenido alcohólico es mínimo. Se recomienda indicarlo en carta como 'con toque de whisky'."
  - q: "¿Se puede usar crema de whisky Bailey's directamente en el helado?"
    a: "No se recomienda. La crema de whisky bebida (Bailey's, Coloma, Copacabana) no está formulada para resistir congelación. Al congelarla, el agua del producto forma cristales grandes, el alcohol se separa de la emulsión y el resultado es una textura granulada con sabor plano. El variegato Whisky MEC3 está específicamente formulado para mantener textura y sabor a -18°C."
  - q: "¿A qué temperatura se dosifica el variegato Whisky?"
    a: "El variegato se dosifica directamente desde el envase a temperatura ambiente (18-22°C). Se añade a la masa de helado en los últimos 30 segundos del ciclo de mantecado, cuando la temperatura del helado es de -4°C a -6°C. A temperaturas más frías el variegato no fluye correctamente y no se integra."
  - q: "¿Cuánto rinde una cubeta de Whisky Variegato MEC3?"
    a: "Con dosificación estándar de 80g por litro de helado base, una cubeta de 3kg de Whisky Variegato MEC3 rinde aproximadamente 37 litros de helado de whisky. A 10 bolas por litro y precio de venta de $8.500 COP la bola, eso representa $3.145.000 COP en ventas brutas por cubeta."
---
...
- Mantiene fluidez a temperaturas entre -6°C y -18°C
- Integra el sabor a whisky con los azúcares en una emulsión estable para congelación
- Retiene el perfil aromático del whisky durante el mantecado y el almacenamiento en vitrina
- Produce el efecto de variegato (veteado visible) sin mezclarse homogéneamente con la base
...
- **Vainilla + whisky:** el contraste entre el dulzor neutro de la vainilla y el amargo del whisky es el más vendido. Funciona en cualquier contexto de precio.
- **Café + whisky:** para heladerías con audiencia adulta. Refuerza el perfil de sabor del café con las notas ahumadas del whisky.
- **Avellana + whisky:** combinación tipo "Irish coffee" en copa. Alta percepción de valor.
...
Para ver el catálogo completo de [salsas especiales para helado](/coberturas-salsas-helado/salsas-especiales/) — incluyendo Whisky Variegato, Tiramisú y Salted Caramel — con fichas técnicas y precios mayoristas, consulta el portafolio completo.

## Combinaciones de sabor que venden más
...
- **Costo del variegato por litro:** precio cubeta / 37 litros = variable según cotización vigente
- **Precio de venta sugerido:** $8.500 - $10.000 COP por bola (premium sobre precio estándar de $6.000-$7.000)
- **Margen bruto por bola:** >80% del precio de venta después de descontar todos los insumos
