# AGENTS.md - Archivo Maestro de Skills para ItalGel
...
Este archivo maestro (`AGENTS.md`) es la columna vertebral para la toma de decisiones de la IA, permitiéndole seleccionar y ejecutar la skill más adecuada para cada tarea solicitada. La IA debe analizar meticulosamente el lenguaje natural del usuario y el contexto del proyecto para determinar la acción correcta.
...
Este archivo `AGENTS.md` es fundamental para una operación eficiente y precisa de la IA en el proyecto Juli.Com.Co. Su correcta interpretación asegura que cada tarea sea dirigida a la herramienta más competente.
