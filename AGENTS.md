...
Este archivo `AGENTS.md` es fundamental para una operación eficiente y precisa de la IA en el proyecto ItalGel. Su correcta interpretación asegura que cada tarea sea dirigida a la herramienta más competente.
